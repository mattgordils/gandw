...
if (document.querySelectorAll('.dropsplash').length){
  //hyper.modules.push(require('./homepage'));
  $("[data-action='edit-toggle']").click(function() {
    console.log('penis');
  });
}
